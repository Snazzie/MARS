...
- Join applies a bounded per-source limiter (maximum 1024 tracked sources, five attempts per minute) before credential verification, returns generic 401s for invalid/throttled attempts, and clears source state after successful verification.
