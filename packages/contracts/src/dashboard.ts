...
export const WorkerDoctor = dto(strict({ nestedKvm: z.boolean().optional(), kvmModules: z.boolean().optional(), versions: strict({ k3s: z.string(), kata: z.string(), containerd: z.string() }).optional(), runtimeHandler: z.string().optional(), runtimeMode: z.enum(["container", "vm", "tart"]).optional(), artifactSource: z.enum(["worker_local", "registry", "template"]).optional(), artifactIdentity: z.string().min(1).optional(), artifactDigest: z.string().regex(/^(?:[^@\s]+@)?sha256:[0-9a-f]{64}$/).optional(), runtimeReady: z.boolean().optional(), probe: z.boolean().optional(), egress: z.boolean().optional(), imageSignatures: z.boolean().optional(), blockVolume: z.boolean().optional(), remediation: z.string().nullable().optional() }));
