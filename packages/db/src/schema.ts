...
export const jobTimingMigrationSql = `CREATE UNIQUE INDEX IF NOT EXISTS dashboard_jobs_org_run_id_idx ON dashboard_jobs(organization_id, run_id, id);
CREATE TABLE IF NOT EXISTS dashboard_job_timing_snapshots (
  organization_id uuid NOT NULL REFERENCES organizations(id) ON DELETE CASCADE,
  job_id uuid NOT NULL,
  run_id uuid NOT NULL,
...
export const resourceTelemetryMigrationSql = `ALTER TABLE dashboard_job_timing_snapshots ADD COLUMN IF NOT EXISTS telemetry_state text NOT NULL DEFAULT 'unavailable';
...
export const workerAnalyticsMigrationSql = `ALTER TABLE dashboard_job_timing_snapshots ADD COLUMN IF NOT EXISTS worker_id uuid;
...
${jobTimingMigrationSql}
${resourceTelemetryMigrationSql}
${workerAnalyticsMigrationSql}`;
