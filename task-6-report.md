...
- Rollback mutation flags are set before each tag write, digest mismatches fail through the ERR trap, rollback restores `errexit` and exits nonzero after cleanup, and rollback errors are surfaced rather than silently ignored.
