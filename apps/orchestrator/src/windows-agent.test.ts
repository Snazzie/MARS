...
import { runWindowsLeaseLifecycle } from "./windows-agent.ts";

const workerId = "11111111-1111-4111-8111-111111111111";
const leaseId = "22222222-2222-4222-8222-222222222222";
const command: WorkerCommand = { version: 1, id: "33333333-3333-4333-8333-333333333333", type: "hyperv.create_lease", workerId, leaseId, occurredAt: new Date().toISOString(), payload: {} };
...
test("reports Hyper-V provisioning failures instead of leaving the lease dispatched", async () => {
  const events: WorkerEvent[] = [];
  const driver = { createLease: async () => { throw new Error("provisioning exploded"); } };
  await runWindowsLeaseLifecycle(command, driver as never, bootstrap, event => events.push(event));
