...
export interface MacWorkerJoinInput { code: string; publicKey: string; vmUuid: string }
export interface MacWorkerJoinPayload extends MacWorkerJoinInput { platform: "macos-arm64" }
export function buildMacWorkerJoinPayload(input: MacWorkerJoinInput): MacWorkerJoinPayload { return { code: input.code, publicKey: input.publicKey, vmUuid: input.vmUuid, platform: "macos-arm64" }; }
