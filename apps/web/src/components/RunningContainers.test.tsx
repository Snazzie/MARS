...
const container: OverviewDto["runningContainers"][number] = {
  id: "lease-1", organizationId: "org-1", jobId: "job-1", runId: "run-1", jobName: "build", repositoryName: "acme/project", workflowName: "CI", workerName: "worker-1", runtime: "windows-hyperv-container", startedAt: "2026-08-17T20:00:00.000Z", cpuUsagePercent: 42.5, memoryWorkingSetBytes: 2 * 1024 ** 3, memoryLimitBytes: 4 * 1024 ** 3, diskUsageBytes: 3 * 1024 ** 3, allocatedStorageBytes: 10 * 1024 ** 3, sampledAt: "2026-08-17T20:05:00.000Z",
};
