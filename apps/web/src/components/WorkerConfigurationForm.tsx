...
type Props = { worker: { id: string; platform?: "linux-x64" | "windows-x64" | "macos-arm64"; guestPlatforms?: ("linux-x64" | "windows-x64" | "macos-arm64")[]; draining?: boolean; activeSandboxes?: number; capacity: WorkerCapacityData; limits: WorkerLimits | null }; organizationId?: string; onConfigured(): void };
const GIB = 1024 ** 3;
