...
$WindowsTrayScriptUrl = 'https://github.com/Snazzie/MARS/releases/download/worker-v0.1.1/mars-worker-tray.ps1'
$WindowsTrayScriptSha256 = $hash
...
$WindowsRunnerUrl = 'https://github.com/Snazzie/MARS/releases/download/worker-v0.1.1/mars-windows-runner.zip'
$WindowsRunnerSha256 = $hash
$WindowsGitUrl = 'https://github.com/Snazzie/MARS/releases/download/worker-v0.1.1/mars-windows-git.zip'
$WindowsGitSha256 = $hash
$WindowsVcRuntimeUrl = 'https://github.com/Snazzie/MARS/releases/download/worker-v0.1.1/mars-windows-vc-runtime.exe'
$WindowsVcRuntimeSha256 = $hash
